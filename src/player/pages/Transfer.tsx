...
export function Transfer({ transfer, locale }: { transfer: TransferData; locale: Locale }) {
  return (
      ...
      <div className="transfer-body">
        <div className="op-row">
          ...
          <div className="op-text">
            ...
            <div className="op-en">{subText(transfer.operator)}</div>
          </div>
        </div>
        {transfer.station && (
          <>
            ...
            <FitText className="station-en" max={56} recalcKey={subText(transfer.station)}>{subText(transfer.station)}</FitText>
          </>
        )}
      </div>
    </div>
